  ...
  Future<void> _deleteEmployee(String employeeId) async {
    try {
      final response = await http.delete(
        Uri.parse("https://hrm-backend-rm6c.onrender.com/api/employees/$employeeId"),
      );
                  ...
                  Padding(
                    ...
                    child: SizedBox(
                      ...
                      child: pickedImageBytes != null
                          ...
                          : Image.network(
                              "https://hrm-backend-rm6c.onrender.com${emp["employeeImage"]}",
                              fit: BoxFit.cover,
                            ),
                    ),
                  ),
              ...
              onPressed: () async {
                try {
                  var request = http.MultipartRequest(
                    'PUT',
                    Uri.parse(
                      "https://hrm-backend-rm6c.onrender.com/api/employees/${idController.text}",
                    ),
                  );
                      ...
                      children: [
                        ...
                        IconButton(
                          ...
                          onPressed: () async {
                            ...
                            final url = Uri.parse(
                              "https://hrm-backend-rm6c.onrender.com/apply/fetch/$empId",
                            );
                            try {
